...
class TreeDataSet(data.Dataset):
    ...
    def get_slice_data(self):
        matrices = np.load(self.data_dir + '/' + str(self.max_ast_size) + '_' + str(self.k) + '/' + self.data_set_name + '_matrices_' +
                           str(self.slices[self.current_slice_index]) + '.npz')
